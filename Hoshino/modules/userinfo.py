...
import Hoshino.modules.sql.userinfo_sql as sql
from Hoshino import (
    DEMONS,
    DEV_USERS,
    SUPPORT_CHAT,
...
from Hoshino.__main__ import STATS, TOKEN, USER_INFO
from Hoshino.modules.disable import DisableAbleCommandHandler
from Hoshino.modules.helper_funcs.chat_status import sudo_plus
from Hoshino.modules.helper_funcs.extraction import extract_user
from Hoshino.modules.sql.global_bans_sql import is_user_gbanned
from Hoshino.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nᴛʜɪs ᴜsᴇʀ ɪs ᴀ ᴍᴇᴍʙᴇʀ ᴏғ ᴅᴇᴠᴇʟᴏᴘᴇʀ.\n"
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/SoulSocietyXBotUpdate/9"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/SoulSocietyXBotUpdate/11"
                            ),
                        ],
                    ]
                ),
...
def stats(update: Update, context: CallbackContext):
    ...
    + "\n\n[𝗨𝗣𝗗𝗔𝗧𝗘𝗦](https://t.me/SoulSocietyXBotUpdate) | [𝗦𝗨𝗣𝗣𝗢𝗥𝗧](https://t.me/SoulSocietyXBotSupport)\n\n  『 Mᴀᴅᴇ Bʏ : [KIRA](https://t.me/SIAmKira) 』 \n"
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Umm... yeah, I only trust ᴅᴇᴠᴇʟᴏᴘᴇʀ to set my bio."
            )
            return
