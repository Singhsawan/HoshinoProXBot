...
import Hoshino.modules.sql.global_bans_sql as sql
from Hoshino import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Hoshino.modules.helper_funcs.misc import send_to_list
from Hoshino.modules.sql.users_sql import get_user_com_chats
