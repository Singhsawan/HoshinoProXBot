...
import Hoshino.modules.sql.global_bans_sql as gban_sql
import Hoshino.modules.sql.users_sql as user_sql
from Hoshino import DEV_USERS, OWNER_ID, dispatcher
