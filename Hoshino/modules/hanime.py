...
#HANIME HANDLER
@pbot.on_message(filters.command("hanime"))
async def hanime(pbot, message):
...
#DOWNLOADS CALLBACK
@pbot.on_callback_query(filters.regex("hdownload"))
...
#DELETE CALLBACK
@pbot.on_callback_query(filters.regex("hclose"))
