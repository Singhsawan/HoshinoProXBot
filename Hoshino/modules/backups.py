...
# from Hoshino.modules.sql import warns_sql as warnssql
import Hoshino.modules.sql.blacklist_sql as blacklistsql

# from Hoshino.modules.sql import cust_filters_sql as filtersql
# import Hoshino.modules.sql.welcome_sql as welcsql
import Hoshino.modules.sql.locks_sql as locksql
import Hoshino.modules.sql.notes_sql as sql

# from Hoshino.modules.rules import get_rules
import Hoshino.modules.sql.rules_sql as rulessql
from Hoshino import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Hoshino.__main__ import DATA_IMPORT
from Hoshino.modules.connection import connected
from Hoshino.modules.helper_funcs.alternate import typing_action
from Hoshino.modules.helper_funcs.chat_status import user_admin
from Hoshino.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Hoshino{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Hoshino{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Hoshino-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Hoshino{}.backup".format(chat_id))  # Cleaning file
