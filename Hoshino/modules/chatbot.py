...
import Hoshino.modules.sql.chatbot_sql as sql
from Hoshino import BOT_ID, BOT_NAME, BOT_USERNAME, dispatcher
from Hoshino.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        request = requests.get(
            f"https://sugoi-api.vercel.app/chat?msg={message.text}"
        )
